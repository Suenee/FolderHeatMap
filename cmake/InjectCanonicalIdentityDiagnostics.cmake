...
if(POS EQUAL -1)
    message(FATAL_ERROR "1.19 canonical identity diagnostic anchor not found")
endif()
string(REPLACE "${OLD}" "${NEW}" ENGINE "${ENGINE}")
string(REPLACE "FolderHeatMap 1.18 safe lifecycle engine starting" "FolderHeatMap 1.19 canonical identity diagnostic engine starting" ENGINE "${ENGINE}")
file(WRITE "${INPUT}" "${ENGINE}")
message(STATUS "Injected FolderHeatMap 1.19 canonical filesystem identity diagnostics: ${INPUT}")
