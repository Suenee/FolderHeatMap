...
function(fhm_replace_once OLD NEW LABEL)
    ...
    if(POS EQUAL -1)
        message(FATAL_ERROR "1.38 TC navigation monitor anchor not found: ${LABEL}")
    endif()
...
if(VERSION_POS EQUAL -1)
    message(FATAL_ERROR "1.38 engine version banner anchor not found")
endif()
string(REPLACE "FolderHeatMap 1.20 canonical lifecycle engine starting"
               "FolderHeatMap 1.38 engine starting (identity-first lifecycle + baseline diagnostic handoff)" ENGINE "${ENGINE}")

file(WRITE "${INPUT}" "${ENGINE}")
message(STATUS "Injected FolderHeatMap 1.38 independent Total Commander navigation monitor: ${INPUT}")
