...
function(fhm_replace_once OLD NEW LABEL)
    ...
    if(POS EQUAL -1)
        message(FATAL_ERROR "1.40 TC navigation monitor anchor not found: ${LABEL}")
    endif()
...
if(VERSION_POS EQUAL -1)
    message(FATAL_ERROR "1.40 engine version banner anchor not found")
endif()
string(REPLACE "FolderHeatMap 1.20 canonical lifecycle engine starting"
               "FolderHeatMap 1.40 engine starting (identity-first move and rename lifecycle)" ENGINE "${ENGINE}")

file(WRITE "${INPUT}" "${ENGINE}")
message(STATUS "Injected FolderHeatMap 1.40 independent Total Commander navigation monitor: ${INPUT}")
