...
function(fhm_replace_once OLD NEW LABEL)
    ...
    if(POS EQUAL -1)
        message(FATAL_ERROR "1.42 TC navigation monitor anchor not found: ${LABEL}")
    endif()
...
if(VERSION_POS EQUAL -1)
    message(FATAL_ERROR "1.42 engine version banner anchor not found")
endif()
string(REPLACE "FolderHeatMap 1.20 canonical lifecycle engine starting"
               "FolderHeatMap 1.42 engine starting (rapid-move reconciliation grace)" ENGINE "${ENGINE}")

file(WRITE "${INPUT}" "${ENGINE}")
message(STATUS "Injected FolderHeatMap 1.42 independent Total Commander navigation monitor: ${INPUT}")
