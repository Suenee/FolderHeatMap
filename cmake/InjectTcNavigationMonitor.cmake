...
function(fhm_replace_once OLD NEW LABEL)
    ...
    if(POS EQUAL -1)
        message(FATAL_ERROR "1.48 TC navigation monitor anchor not found: ${LABEL}")
    endif()
...
if(VERSION_POS EQUAL -1)
    message(FATAL_ERROR "1.48 engine version banner anchor not found")
endif()
string(REPLACE "FolderHeatMap 1.20 canonical lifecycle engine starting"
               "FolderHeatMap 1.48 engine starting (surviving File ID path reconciliation)" ENGINE "${ENGINE}")

file(WRITE "${INPUT}" "${ENGINE}")
message(STATUS "Injected FolderHeatMap 1.48 independent Total Commander navigation monitor: ${INPUT}")
