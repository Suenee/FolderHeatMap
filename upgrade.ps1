...
$Version = '1.32'
$Revision = '1.32-test-parser-preflight'
...
try {
    ...
    Info '[5/7] Building FolderHeatMap 1.32 and tools...'; Run-Native -Phase 'BUILD' -Exe $cmake -ArgumentList @('--build','build','--config','Release','--target','FolderHeatMap','FolderHeatMapEngine','FolderHeatMapConfig','FolderHeatMapReset')|Out-Null
