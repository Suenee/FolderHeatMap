...
$Version = '1.30'
$Revision = '1.30-engine-deploy-guard'
...
try {
    ...
    Info '[5/7] Building FolderHeatMap 1.30 and tools...'; Run-Native -Phase 'BUILD' -Exe $cmake -ArgumentList @('--build','build','--config','Release','--target','FolderHeatMap','FolderHeatMapEngine','FolderHeatMapConfig','FolderHeatMapReset')|Out-Null
