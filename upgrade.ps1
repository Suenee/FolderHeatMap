...
$Version = '1.35'
$Revision = '1.35-stress-workspace-release'
...
try {
    ...
    Info '[5/7] Building FolderHeatMap 1.35 and tools...'; Run-Native -Phase 'BUILD' -Exe $cmake -ArgumentList @('--build','build','--config','Release','--target','FolderHeatMap','FolderHeatMapEngine','FolderHeatMapConfig','FolderHeatMapReset')|Out-Null
