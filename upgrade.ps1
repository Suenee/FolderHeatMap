...
$Version = '1.17'
$Revision = '1.17-delete-lifecycle'
...
try {
    ...
    Info '[5/7] Building FolderHeatMap 1.17 lifecycle engine and tools...'; Run-Native -Phase 'BUILD' -Exe $cmake -ArgumentList @('--build','build','--config','Release','--target','FolderHeatMap','FolderHeatMapEngine','FolderHeatMapConfig','FolderHeatMapReset') | Out-Null
