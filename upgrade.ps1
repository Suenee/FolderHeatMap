...
$Version = '1.37'
$Revision = '1.37-lifecycle-diagnostic-tests'
...
try {
    ...
    Info '[5/7] Building FolderHeatMap 1.37 and tools...'; Run-Native -Phase 'BUILD' -Exe $cmake -ArgumentList @('--build','build','--config','Release','--target','FolderHeatMap','FolderHeatMapEngine','FolderHeatMapConfig','FolderHeatMapReset')|Out-Null
