...
$Version = '1.43'
$Revision = '1.43-rapid-move-returned-object'
...
try {
    ...
    Info '[5/7] Building FolderHeatMap 1.43 and tools...'; Run-Native -Phase 'BUILD' -Exe $cmake -ArgumentList @('--build','build','--config','Release','--target','FolderHeatMap','FolderHeatMapEngine','FolderHeatMapConfig','FolderHeatMapReset')|Out-Null
