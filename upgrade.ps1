...
$Version = '1.31'
$Revision = '1.31-automated-move-tests'
...
try {
    ...
    Info '[5/7] Building FolderHeatMap 1.31 and tools...'; Run-Native -Phase 'BUILD' -Exe $cmake -ArgumentList @('--build','build','--config','Release','--target','FolderHeatMap','FolderHeatMapEngine','FolderHeatMapConfig','FolderHeatMapReset')|Out-Null
